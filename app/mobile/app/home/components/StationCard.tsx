	...
	return (
		...
		>
			<Pressable style={styles.pressable} onPress={handlePress}>
				...
				{!isCompatible && (
					<View style={styles.incompatibleMessageContainer}>
						<Text style={styles.incompatibleMessage}>
							This station does not have the needed type of
							charger.
						</Text>
					</View>
				)}
